...
router.post("/", async (req, res) => {
  ...
  const {
    ...
    lifestyle,
    activityLevel,
    workoutDays, // optional field: number of workout days per week (string or number)
  } = formData;
...
`;
  ...
  // Append JSON output format instructions based on workout type.
...
`;
  ...
  try {
    ...
    // Additional cleaning step: remove newlines and extra spaces
    ...
    let tableRows = "";
    const dayNames = allDayNames; // ["Monday", ... , "Sunday"]
    dayNames.forEach(day => {
      ...
      if (designatedWorkoutDays.indexOf(day) === -1) {
        ...
        // This day is designated as a workout day.
    ...
    // Update the header to reflect the workout type and include designated workout days.
    ...
    // Build extra guidance dynamically based on workout type.
    ...
    // Add session duration/frequency guidance based on time commitment and workout style.
